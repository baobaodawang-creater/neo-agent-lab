...
> 一套自托管的多 Agent AI 系统，基于 OpenClaw 构建。8 个 Agent 各司其职，6 个 Telegram 机器人，本地模型 + 云端 API 混合部署。
...
| fakao | DeepSeek | 法考助手 ⚖️ | @fakao2026_bot |
...
- [Agent 配置说明](docs/agents.md) — 8 个 Agent 的身份和分工
